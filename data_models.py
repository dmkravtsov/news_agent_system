...
class NewsItem(BaseModel):
    ...
    full_text: str = Field(..., description="The full text of the news item")
    ...
    category: Optional[str] = Field(None, description="The category of the news item (e.g., politics, sports)")
    language: Optional[str] = Field(None, description="The language of the news item")
    sentiment: Optional[float] = Field(
        0.0, ge=-1.0, le=1.0, description="The sentiment score of the news item (-1.0 to 1.0)"
    )
